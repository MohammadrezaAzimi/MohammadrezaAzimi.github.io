...
6. To combat the overfitting problem, L2 regularization is used with weight coefficient `\lambda=0.001`. The accuracy for the validation set is .92 after 4 epochs.  
